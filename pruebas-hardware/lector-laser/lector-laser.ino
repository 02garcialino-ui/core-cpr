...
//
//  Lee la distancia cada 300ms y la imprime en cm. Acerca y aleja
//  la mano (u otro objeto) del sensor para ver el numero cambiar.
//
//  Necesita la libreria "Adafruit VL53L0X" (Arduino IDE: Sketch >
//  Include Library > Manage Libraries > buscar "Adafruit VL53L0X").
//
